...
def mouse_left_click(x=None, y=None, release=None):
    ...
    if release is None or release == 1:
        ...
        win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0)
mouse_left_click(341, 563,0)
mouse_move(594, 559)
mouse_left_click(594, 559)
def mouse_right_click(x=None, y=None, release=None):
    if not x is None and not y is None:
        mouse_move(x,y)
        time.sleep(0.5)
    if release is None or release == 1:
...
def key_function(str=''):
    tarstr = str.upper()
    key_combination(VK_CODE[tarstr])
...
def key_input(str=''):
    for c in str:
        key_combination(VK_CODE[c])

#def mouse_left_click1(x, y):
#
#    mouse_move(x,y)
#    time.sleep(2)
#    win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0)
